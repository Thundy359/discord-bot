...
module.exports = {
  /**
   * Command callback to kick a member from the server
   * @param {Client} client
  ...
  callback: async (client, interaction) => {
    ...
    // Compare roles of the target user, requesting user, and bot
    ...
    // Attempt to kick the target user and reply with the result
    try {
  ...
  permissionsRequired: [PermissionFlagsBits.KickMembers], // Permissions required by the user
  botPermissions: [PermissionFlagsBits.KickMembers], // Permissions required by the bot
};
